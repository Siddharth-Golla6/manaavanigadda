  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <h1 className="flex items-center gap-2 text-3xl font-extrabold text-neutral-900 dark:text-white">
        <Megaphone className="text-brand-red" /> Announcements
      </h1>
      <p className="mt-1 mb-8 text-sm text-neutral-500 dark:text-neutral-400">
        Official updates from the Mandal and Administrator teams.
      </p>
      ...
      <div className="space-y-4">
        ...
        {announcements.length === 0 && (
          <GlassCard className="py-12 text-center text-neutral-500">No announcements yet.</GlassCard>
        )}
      </div>
    </div>
  );
